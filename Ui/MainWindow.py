...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.WNRAction = QtWidgets.QAction(MainWindow)
        self.WNRAction.setObjectName("WNRAction")
        self.ASFAction = QtWidgets.QAction(MainWindow)
        self.ASFAction.setObjectName("ASFAction")
        self.GammaAction = QtWidgets.QAction(MainWindow)
        self.GammaAction.setObjectName("GammaAction")
        self.menu.addAction(self.TestAction)
        self.menu.addAction(self.GammaAction)
        self.menu.addAction(self.WNRAction)
        self.menu.addAction(self.ASFAction)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.WNRAction.setText(_translate("MainWindow", "WNR"))
        self.WNRAction.setShortcut(_translate("MainWindow", "F1"))
        self.ASFAction.setText(_translate("MainWindow", "ASF"))
        self.ASFAction.setShortcut(_translate("MainWindow", "F2"))
        self.GammaAction.setText(_translate("MainWindow", "GAMMA"))
        self.GammaAction.setShortcut(_translate("MainWindow", "F3"))
